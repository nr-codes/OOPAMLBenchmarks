...
solv = solver.Solver.make_solver('ipopt', prb, opts={'ipopt.tol': 1e-4,'ipopt.max_iter': 2000, 'ipopt.print_user_options': 'yes'})

# ==================== SOLVE PROBLEM ===============================
solv.solve()

end = time.perf_counter()
print(f"Python3 Elapsed: {repr(end - start)} seconds")
