...
var Ev {i1 in SPAT_XV, i2 in SPAT_M, i3 in SPAT_M, i4 in GLOBAL_GRID: i2 <= 3 and i3 <= 3} =
...
# px = (p) x = skew-symmetric matrix of p = (-E r) x
var pvx {i1 in SPAT_XV, i2 in SPAT_M, i3 in SPAT_M, i4 in GLOBAL_GRID: i2 <= 3 and i3 <= 3} =
...
var spat_X_ip {i1 in SPAT_L[1], i2 in SPAT_M, i3 in SPAT_M, i4 in GLOBAL_GRID} =
...
var TJ_X_ob {i2 in F, i3 in TJ_F[i2], i4 in SPAT_M, i5 in SPAT_M, i6 in GLOBAL_GRID} =
